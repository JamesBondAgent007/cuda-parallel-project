...
src/BenchCuda/%.o: ../src/BenchCuda/%.cu
	...
	/Developer/NVIDIA/CUDA-7.5/bin/nvcc -I/usr/local/Cellar/opencv/2.4.12_2/include/opencv -G -g -O0 -gencode arch=compute_30,code=sm_30  -odir "src/BenchCuda" -M -o "$(@:%.o=%.d)" "$<"
